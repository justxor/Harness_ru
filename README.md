...
Тринадцать схем курса, собранные в одном месте. Если вы возвращаетесь к материалу через месяц, читать стоит именно их: текст восстанавливается по картинке, а картинка по тексту — нет.
